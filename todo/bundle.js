...
var _steps_reducer = __webpack_require__(83);

var _steps_reducer2 = _interopRequireDefault(_steps_reducer);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var rootReducer = (0, _redux.combineReducers)({ todos: _todos_reducer2.default, steps: _steps_reducer2.default });
...
var todosReducer = function todosReducer() {
  ...
  switch (action.type) {
    ...
    case _todo_actions.REMOVE_TODO:
      var rState = Object.assign({}, state);
...
var allTodos = exports.allTodos = function allTodos(state) {
  ...
  return todoKeys.map(function (id) {
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      todos.map(function (todo) {
        return _react2.default.createElement(_todo_list_item2.default, { key: todo.id, todo: todo, receiveTodo: receiveTodo });
      })
    ),
...
var _todo_detail_view_container = __webpack_require__(82);
...
var doneHelper = function doneHelper(todo, receiveTodo) {
  todo.done = !todo.done;
  receiveTodo(todo);
};
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          { type: 'button', onClick: function onClick() {
              return doneHelper(todo, receiveTodo);
            } },
          todo.done ? "Undo" : "Done"
        ),
        this.state.showDetail ? _react2.default.createElement(_todo_detail_view_container2.default, { todo: todo }) : ''
      );
    }
  }]);
...
var TodoForm = function (_React$Component) {
  ...
  _createClass(TodoForm, [{
    ...
    value: function handleChangeBody(e) {
      this.setState({
        body: e.target.value
      });
    }
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'form',
        { className: 'todo-form' },
        _react2.default.createElement('input', { type: 'text', name: 'title', value: this.state.title, onChange: this.handleChangeTitle }),
        _react2.default.createElement('input', { type: 'text', name: 'body', value: this.state.body, onChange: this.handleChangeBody }),
        _react2.default.createElement(
          'button',
          { type: 'submit', name: 'button', onClick: this.getFormData },
          'Add Todo'
        )
      );
    }
...
var _step_actions = __webpack_require__(84);
